...
local sup_letters = { 
    ...
    ["a"] = "ᵃ", ["b"] = "ᵇ", ["c"] = "ᶜ", ["d"] = "ᵈ", ["e"] = "ᵉ", ["f"] = "ᶠ", ["g"] = "ᵍ", ["h"] = "ʰ", ["k"] = "ᵏ", ["l"] = "ˡ", ["m"] = "ᵐ", ["o"] = "ᵒ", ["p"] = "ᵖ", ["r"] = "ʳ", ["s"] = "ˢ", ["t"] = "ᵗ", ["u"] = "ᵘ", ["v"] = "ᵛ",  ["x"] = "ˣ", ["y"] = "ʸ", ["z"] = "ᶻ",
    ["α"] = "ᵅ", ["β"] = "ᵝ", ["γ"] = "ᵞ", ["δ"] = "ᵟ", ["ε"] = "ᵋ", ["θ"] = "ᶿ", ["ι"] = "ᶥ", ["φ"] = "ᶲ", ["χ"] = "ᵡ",
}
  ...
  if sub and not sup then 
    ...
    local sub_t
  	...
  	if subscript and string.len(subscript) > 0 then
        -- try super script variant
        if sup_letters[subscript] then
            subscript = sup_letters[subscript]
        end
